...
parser.add_argument(
    "-t", "--ticker", required=True, help="Ticker (symbol) to use for simulation"
)
parser.add_argument(
    "-d",
    "--historical-date",
...
parser.add_argument(
    "--start-time", default="09:30:00", type=parse, help="Starting time of simulation."
)
parser.add_argument(
    "--end-time", default="11:30:00", type=parse, help="Ending time of simulation."
)
parser.add_argument(
    "-l",
    "--log_dir",
...
parser.add_argument(
    "--mm-window-size", type=util.validate_window_size, default="adaptive"
)
...
latency_model = LatencyModel(
    latency_model="deterministic", random_state=latency_rstate, kwargs=model_args
)
# KERNEL
...
print(
    "Time taken to run simulation: {}".format(
